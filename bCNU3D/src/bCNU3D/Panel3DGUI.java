...
public class Panel3DGUI extends javax.swing.JPanel {
    ...
    private void guiScaleXPropertyChange(KeyEvent evt) {       
        ...
        Panel3DOther.deltaX=Float.valueOf(guiScaleX.getText());
    	}
    	}
    	catch(Exception e) {
    		//do nothing
    ...
    private void guiScaleYPropertyChange(KeyEvent evt) {       
        ...
        Panel3DOther.deltaY=Float.valueOf(guiScaleY.getText());
    	}
    	}
    	catch(Exception e) {
    		//do nothing
    ...
    private void guiScaleZPropertyChange(KeyEvent evt) {       
        ...
        Panel3DOther.deltaZ=Float.valueOf(guiScaleZ.getText());
    	}
    	}
    	catch(Exception e) {
    		//do nothing
    ...
    private void guiTickXPropertyChange(KeyEvent evt) {       
    	try {
        Panel3DOther.numOfSegmentsX=Float.valueOf(guiTickX.getText());
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiTickYPropertyChange(KeyEvent evt) {       
    	try {
        Panel3DOther.numOfSegmentsY=Float.valueOf(guiTickY.getText());
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiTickZPropertyChange(KeyEvent evt) {       
    	try {
        Panel3DOther.numOfSegmentsZ=Float.valueOf(guiTickZ.getText());
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiRotXPropertyChange(KeyEvent evt) {       
    	try {
        Panel3DOther.setRotY(Float.valueOf(guiRotX.getText()));
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiRotYPropertyChange(KeyEvent evt) {       
    	try {
        Panel3DOther.setRotZ(Float.valueOf(guiRotY.getText()));
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiRotZPropertyChange(KeyEvent evt) {       
    	try {
        Panel3DOther.setRotX(Float.valueOf(guiRotZ.getText()));
    	}
    	catch(Exception e) {
    		//do nothing
    	}
