	...
	public static void main(String arg[]) {
		...
		PointSetPanel3D p3d = new PointSetPanel3D(thetax, thetay, thetaz, xdist, ydist, zdist) {
			...
			public void createInitialItems() {
				...
				Axes3D axes = new Axes3D(this, -xymax, xymax, -xymax, xymax, zmin, zmax, labels, Color.darkGray, 2f, 7,
						7, 8, Color.black, Color.blue, new Font("SansSerif", Font.PLAIN, 32), 0);
				addItem(axes);
