...
//	public static final String SHOW_TB_DOCA = "TB DOCA";
	...
	private AlphaSliderImp2 _volumeAlphaSlider;

	// display array labels
	private String _cbaLabels[];

	private CedView3DImp2 _view;
	
	final int init_alpha = 24;
	 ...
	 */
	public CedPanel3DImp2(CedView3DImp2 view, float angleX, float angleY, float angleZ, float xDist, float yDist,
			float zDist, float bgRed, float bgGreen, float bgBlue, String... cbaLabels) {
		super(view, view.mainDisplay.outputPanel, angleX, angleY, angleZ, xDist, yDist, zDist, bgRed, bgGreen,
				bgBlue);
		_view = view;
...
//			}
	...
	public void display(GLAutoDrawable drawable) {
		if (VirtualView.getInstance() == null || VirtualView.getInstance().isViewVisible(getView())) {
	...
	private void addNorth() {
		...
		_volumeAlphaSlider = new AlphaSliderImp2(this, "Volume alpha");
		_volumeAlphaSlider.getSlider().addChangeListener(new ChangeListener() {
			@Override
			public void stateChanged(ChangeEvent event) {
				handleSliderInterrupt(event);
			}
	...
	private void addEast() {
		...
		ep.add(new KeyboardLegendImp2(this));
		...
		AbstractButton[] allCheckBoxes = this.getAllDisplayButtons();
		for(AbstractButton temp : allCheckBoxes) {
			temp.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					handleCheckBoxInterrupt(e);
				}
		...
		for (Item3DImp2 detectorItem : _itemList2) {
			...
			if(detectorItem.getChildren() != null) {
				for (Item3DImp2 detectorItem2 : detectorItem.getChildren()) {
					detectorItem2.handleSliderInterrupt(e);
			}
		 }
	  }
	}
	...
	public void handleCheckBoxInterrupt(ActionEvent e) {
		for (Item3DImp2 detectorItem : _itemList2) {
			...
			if(detectorItem.getChildren() != null) {
				for (Item3DImp2 detectorItem2 : detectorItem.getChildren()) {
					detectorItem2.handleCheckBoxInterrupt(e);
			}
		}
		}
	}
	 ...
	 */
	public AbstractButton[] getAllDisplayButtons() {
	 ...
	 */
	protected boolean show(String label) {
	...
	public boolean showECAL() {
		return show(CedPanel3DImp2.SHOW_ECAL);
	}
	...
	public boolean showPCAL() {
		return show(CedPanel3DImp2.SHOW_PCAL);
	}
	...
	public boolean showFTOF() {
		return show(CedPanel3DImp2.SHOW_FTOF);
	}
	...
	public boolean showCTOF() {
		return show(CedPanel3DImp2.SHOW_CTOF);
	}
	...
	public boolean showBST() {
		return show(CedPanel3DImp2.SHOW_BST);
	}
	...
	public boolean showBMT() {
		return show(CedPanel3DImp2.SHOW_BMT);
	}
	...
	public boolean showCND() {
		return show(CedPanel3DImp2.SHOW_CND);
	}
	...
	public boolean showCNDLayer1() {
		return showCND() && show(CedPanel3DImp2.SHOW_CND_LAYER_1);
	}
	...
	public boolean showCNDLayer2() {
		return showCND() && show(CedPanel3DImp2.SHOW_CND_LAYER_2);
	}
	...
	public boolean showCNDLayer3() {
		return showCND() && show(CedPanel3DImp2.SHOW_CND_LAYER_3);
	}
	...
	public boolean showReconCrosses() {
		return show(CedPanel3DImp2.SHOW_RECON_CROSSES);
	}
	...
	public boolean showReconFTOF() {
		return show(CedPanel3DImp2.SHOW_RECON_FTOF);
	}
	...
	public boolean showTBTrack() {
		return show(CedPanel3DImp2.SHOW_TB_TRACK);
	}
	...
	public boolean showHBTrack() {
		return show(CedPanel3DImp2.SHOW_HB_TRACK);
	}
	...
	public boolean showAITBTrack() {
		return show(CedPanel3DImp2.SHOW_AITB_TRACK);
	}
	...
	public boolean showAIHBTrack() {
		return show(CedPanel3DImp2.SHOW_AIHB_TRACK);
	}
	...
	public boolean showRecTrack() {
		return show(CedPanel3DImp2.SHOW_REC_TRACK);
	}
	...
	public boolean showRecCal() {
		return show(CedPanel3DImp2.SHOW_REC_CAL);
	}
	...
	public boolean showMapExtents() {
		return show(CedPanel3DImp2.SHOW_MAP_EXTENTS);
	}
	...
	public boolean showCVTTrack() {
		return show(CedPanel3DImp2.SHOW_CVT_TRACK);
	}
	...
	public boolean showHBCross() {
		return show(CedPanel3DImp2.SHOW_HB_CROSS);
	}
	...
	public boolean showTBCross() {
		return show(CedPanel3DImp2.SHOW_TB_CROSS);
	}
	...
	public boolean showAIHBCross() {
		return show(CedPanel3DImp2.SHOW_AIHB_CROSS);
	}
	...
	public boolean showAITBCross() {
		return show(CedPanel3DImp2.SHOW_AITB_CROSS);
	}
	...
	public boolean showBSTHits() {
		return show(CedPanel3DImp2.SHOW_BST_HITS);
	}
	...
	public boolean showBMTHits() {
		return show(CedPanel3DImp2.SHOW_BMT_HITS);
	}
	...
	public boolean showDC() {
		return show(CedPanel3DImp2.SHOW_DC);
	}
	...
	public boolean showBSTLayer1() {
		return showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_1);
	}
	...
	public boolean showBSTLayer2() {
		return showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_2);
	}
	...
	public boolean showBSTLayer3() {
		return showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_3);
	}
	...
	public boolean showBSTLayer4() {
		return showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_4);
	}
	...
	public boolean showBSTLayer5() {
		return showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_5);
	}
	...
	public boolean showBSTLayer6() {
		return showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_6);
	}
	...
	public boolean showBSTLayer7() {
		...
		return oldBSTGeometry && showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_7);
	}
	...
	public boolean showBSTLayer8() {
		boolean oldBSTGeometry = Ced.getCed().useOldBSTGeometry();
		return oldBSTGeometry && showBST() && show(CedPanel3DImp2.SHOW_BST_LAYER_8);
	}
	...
	public boolean showBMTLayer1() {
		return showBMT() && show(CedPanel3DImp2.SHOW_BMT_LAYER_1);
	}
	...
	public boolean showBMTLayer2() {
		return showBMT() && show(CedPanel3DImp2.SHOW_BMT_LAYER_2);
	}
	...
	public boolean showBMTLayer3() {
		return showBMT() && show(CedPanel3DImp2.SHOW_BMT_LAYER_3);
	}
	...
	public boolean showBMTLayer4() {
		return showBMT() && show(CedPanel3DImp2.SHOW_BMT_LAYER_4);
	}
	...
	public boolean showBMTLayer5() {
		return showBMT() && show(CedPanel3DImp2.SHOW_BMT_LAYER_5);
	}
	...
	public boolean showBMTLayer6() {
		return showBMT() && show(CedPanel3DImp2.SHOW_BMT_LAYER_6);
	}
	...
	public boolean showSector1() {
		return show(CedPanel3DImp2.SHOW_SECTOR_1);
	}
	...
	public boolean showSector2() {
		return show(CedPanel3DImp2.SHOW_SECTOR_2);
	}
	...
	public boolean showSector3() {
		return show(CedPanel3DImp2.SHOW_SECTOR_3);
	}
	...
	public boolean showSector4() {
		return show(CedPanel3DImp2.SHOW_SECTOR_4);
	}
	...
	public boolean showSector5() {
		return show(CedPanel3DImp2.SHOW_SECTOR_5);
	}
	...
	public boolean showSector6() {
		return show(CedPanel3DImp2.SHOW_SECTOR_6);
	}
	...
	public boolean showCosmics() {
		return show(CedPanel3DImp2.SHOW_COSMIC);
	}
	...
	public boolean showMCTruth() {
		return show(CedPanel3DImp2.SHOW_TRUTH);
	}
	...
	public boolean showVolumes() {
		return show(CedPanel3DImp2.SHOW_VOLUMES);
	}

	public CedView3DImp2 getView() {
		return _view;
	}
