 ...
 * @author hfrie
 */
public class ForwardDetectorGUI extends javax.swing.JPanel {

    /**
     * Creates new form GUIPanelTest
     */
    public ForwardDetectorGUI() {
        initComponents();
    }
    ...
    private void guiScaleXPropertyChange(KeyEvent evt) {       
        ...
        //Scene.deltaX=Float.valueOf(guiScaleX.getText());
    	}
    	}
    	catch(Exception e) {
    		//do nothing
    ...
    private void guiScaleYPropertyChange(KeyEvent evt) {       
        ...
        //Scene.deltaY=Float.valueOf(guiScaleY.getText());
    	}
    	}
    	catch(Exception e) {
    		//do nothing
    ...
    private void guiScaleZPropertyChange(KeyEvent evt) {       
        ...
        //Scene.deltaZ=Float.valueOf(guiScaleZ.getText());
    	}
    	}
    	catch(Exception e) {
    		//do nothing
    ...
    private void guiTickXPropertyChange(KeyEvent evt) {       
    	try {
        //Scene.numOfSegmentsX=Float.valueOf(guiTickX.getText());
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiTickYPropertyChange(KeyEvent evt) {       
    	try {
        //Scene.numOfSegmentsY=Float.valueOf(guiTickY.getText());
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiTickZPropertyChange(KeyEvent evt) {       
    	try {
        //Scene.numOfSegmentsZ=Float.valueOf(guiTickZ.getText());
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiRotXPropertyChange(KeyEvent evt) {       
    	try {
        //Scene.setRotY(Float.valueOf(guiRotX.getText()));
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiRotYPropertyChange(KeyEvent evt) {       
    	try {
        //Scene.setRotZ(Float.valueOf(guiRotY.getText()));
    	}
    	catch(Exception e) {
    		//do nothing
    	}
    ...
    private void guiRotZPropertyChange(KeyEvent evt) {       
    	try {
        //Scene.setRotX(Float.valueOf(guiRotZ.getText()));
    	}
    	catch(Exception e) {
    		//do nothing
    	}
